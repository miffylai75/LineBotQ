...
def getLocationConfirmMessage(title, latitude, longitude):
    ...
    data1 = {"title": title, "latitude": latitude, "longitude": longitude, "action": "get_near"}
    data2 = {"title": title, "latitude": latitude, "longitude": longitude, "action": "deny"}
    message["template"] = {
          "type": "confirm",
